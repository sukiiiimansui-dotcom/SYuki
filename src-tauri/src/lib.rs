...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::bilibili::bili_hot,
            api::bilibili::bili_search,
            api::bilibili::bili_learn,
            api::bilibili::bili_knowledge,
            api::bilibili::bili_recent_context,
            api::netmusic::netmusic_search,
